...
performance: testsrc/performance.o cu/MT.o cu/conf.o testcu/conf_test.o cu/particles.o testcu/particles_test.o cu/cells.o testcu/cells_test.o cu/jamming.o testcu/jamming_test.o
	nvcc -arch=sm_60 -o $@ $^
